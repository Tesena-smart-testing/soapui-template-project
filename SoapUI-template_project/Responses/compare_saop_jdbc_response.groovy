...
def soap = getDetails(xmlResponse, 'item', 'category_id', 'category_name')  // change this based on the response nodes
log.info soap
def jdbc = getDetails(jdbcResponse, 'Row', 'CATEGORY.CAT_ID', 'CATEGORY.CAT_NAME')  // change this based on the response nodes
log.info jdbc
